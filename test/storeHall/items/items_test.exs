defmodule StoreHall.ItemsTest do
  ...
  describe "items" do
    ...
    @valid_attrs %{details: %{}, name: "some name", user_id: 42}
    @update_attrs %{details: %{}, name: "some updated name", user_id: 43}
    @invalid_attrs %{details: nil, name: nil, user_id: nil}
